...
const spinnerCss = computed(() => {
  let spinnerCss = $attrs.disabled ? ' cursor-not-allowed opacity-25' : ''
  return spinnerCss
})
</script>
...
<template>
  ...
  >
    <span v-if="isLoading">
      <svg
        class="w-6 h-6 mr-2 text-gray-200 animate-spin stroke-red-800 fill-red-800 hover:stroke-red-700 hover:fill-red-700"
        :class="spinnerCss"
        viewBox="0 0 100 101"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
